...
def download_input_data(dst_data_folder, day):
        url = f"https://adventofcode.com/2018/day/{int(day)}/input"
...
def add_app_calling(app_java_file, day) :
    ...
    for i, line in enumerate(lines):
        if "new advc_2018.day" in line:
            if f"new advc_2018.day{day}" in line:
    ...
    if insertion_index is not None:
        # Insert the new line
        new_line = f"        new advc_2018.day{day}.Solution().run();\n"
